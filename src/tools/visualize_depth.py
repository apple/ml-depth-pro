...
def visualize_depth_with_open3d(depth, image_rgb):
    ...
    o3d.visualization.draw_geometries([pcd, coordinate_frame])    # visualize the point cloud with axes
...
if __name__ == "__main__":
    ...
    visualize_depth_with_open3d(depth, image)
